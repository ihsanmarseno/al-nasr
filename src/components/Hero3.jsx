...
const Hero3 = () => {
  ...
  return (
    <div className="h-full mx-[100px] mt-[78px]">
      ...
      <div className="flex flex-row gap-[78px] mt-[72px]">
        <div className="w-[361px] h-[549px] bg-white rounded-[10px] shadow-xl">
          <div className="ml-[10px]">
            ...
            <div className="mt-[20px] ml-[15px] mb-[30px]">
              <button className="text-[#FFC265] bg-white font-nunito font-semibold text-[12px] py-4 px-9 border-[#FFC265] border-[2px] rounded-[5px]">View Detail</button>
            </div>
          </div>
        </div>
